...
void init() {
	...
	char* vertexShaderCode = readTextFile("E:\\Документы\\ДЗ\\3D моделирование\\Лабораторные\\laba1\\2.vs");
	...
	char* fragmentShaderCode = readTextFile("E:\\Документы\\ДЗ\\3D моделирование\\Лабораторные\\laba1\\2.fs");
	...
	// загружаем картинку
	unsigned char *image = 
		SOIL_load_image("E:\\Документы\\ДЗ\\3D моделирование\\Лабораторные\\laba1\\nature.jpg", &width, &height, NULL, SOIL_LOAD_RGB);
...
void display() {
	...
	glVertexAttrib1f(attrLocation, 1.0); // значение атрибута
